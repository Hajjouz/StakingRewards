// src/lib.rs
/*
 * Core library for StakingRewards
 */
...
#[derive(Debug)]
pub struct StakingRewardsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StakingRewardsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StakingRewards processing");
    
    let mut processor = StakingRewardsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StakingRewardsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StakingRewardsProcessor::new(false);
